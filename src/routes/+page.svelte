...
<div class="overflow-hidden font-nunito">
	...
	>
		...
		>
			<p>
				<b>SUPER DEAL</b>: 30% på dina favoriträtter på Foodora.{' '}
				<a class="underline hover:no-underline" href="#"> Läs mer </a>
			</p>
		</div>
	...
	<div class="container lg:grid grid-cols-2 py-24">
		<div class="h-full flex justify-center">
			<div class="relative hidden lg:block h-96" style="aspect-ratio: 1;">
				<div class="absolute bottom-[10%] h-full w-full">
					<div class="absolute bottom-[20%] left-0 h-2/5 w-2/3 bg-gray-100 rounded-3xl" />
					<div class="absolute bottom-0 right-0 h-2/5 w-2/3 bg-si-red rounded-3xl" />
					<img src="/hand.png" class="absolute right-0 h-full" alt="" />
				</div>
			</div>
		</div>

		<div class="flex flex-col justify-center">
			<h2 class="font-lora text-4xl font-semibold mb-2.5">Lipsum</h2>

			<p class="text-xl max-w-2xl">
				Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus iste rem veritatis
				reiciendis deleniti! Laboriosam accusantium culpa vitae eligendi quia vero reiciendis
				dignissimos, consequuntur id laborum, blanditiis maiores cum dolore.
				<br />
				<br />
				Följ oss online:
				<br />
				<a class="underline hover:no-underline" href="#"> Facebook </a>
				<br />
				<a class="underline hover:no-underline" href="#"> Instagram </a>
			</p>
		</div>
	</div>
	...
	>
		...
		>
			<div>
				<h2 class="font-lora text-4xl font-semibold mb-2.5">Har du bråttom?</h2>
				<p class="text-xl">Beställ enkelt online eller via telefon!</p>
			</div>
	...
	<div class="container py-24">
		<h2 class="font-lora text-5xl font-semibold mb-2.5">Meny</h2>
		<p class="text-xl max-w-2xl">
			Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus eleifend lectus neque, eget
			euismod velit maximus convallis.
		</p>
	...
	<div class="bg-si-red text-white">
		<footer class="container flex justify-center text-center py-6">
			<span>
				Copyright 2022 &copy;{' '}
				<a class="underline hover:no-underline" href="https://seabird.digital">
					Seabird Digital UD
				</a>
