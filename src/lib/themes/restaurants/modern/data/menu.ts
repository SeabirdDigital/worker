...
const menu: Menu = [
		...
		dishes: [
			{
				...
				description: 'Spaghetti med hemlagad köttfärssås och parmesan ost.',
				price: 119
			},
			{
				name: 'Penne al tonno',
				description: 'Penne pasta med hemlagad tonfisksås och persilja.',
				price: 119
			},
			{
			...
			{
				name: 'Vegetarian',
				description: 'Lök, champinjoner, paprika, svarta oliver, tomatsås och parmesan ost.',
				price: 109
			}
		]
	},
	{
		...
		dishes: [
			{
				name: 'Margherita',
				description: 'Tomat san marzano, fior di latte mozzarella, basilka, extra jungfurolivolja',
				price: 95
			},
			{
				name: 'La Siciliana',
				description: 'Tomat san marzano, fior di latte mozzarella, aubergine, basilka',
				price: 115
			},
			{
				name: 'Bufalina',
				description: 'Tomat san marzano, mozzarella di bufala, basilka, extra jungfruolivolja',
				price: 119
			},
			{
				name: 'Ortolana',
			...
			{
				name: 'Romana Pizza',
				description: 'San Marzano tomatsås, buffalomozzarella, kyckling, svamp och svarta oliver.',
				price: 110
			},
			{
				name: 'Kycklingpizza',
		...
		dishes: [
			{
				...
				description: 'Tomat san marzano, oregano, basilika, vitlök, extra jungfruolivolja',
				price: 90
			},
			{
				name: 'Vegansk La Berta',
				description: 'Friarielli, kokt krossad potatis, aubergine, basilika, extra jungfruolivolja',
				price: 110
			},
			{
